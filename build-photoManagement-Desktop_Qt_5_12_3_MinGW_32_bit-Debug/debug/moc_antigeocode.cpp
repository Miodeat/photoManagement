...
#include "../../photoManagement/antigeocode.h"
...
QT_MOC_LITERAL(3, 26, 3) // "add"

    },
    "AntiGeoCode\0slotFinished\0\0add"
};
...
void AntiGeoCode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotFinished((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AntiGeoCode::*)(QString );
...
// SIGNAL 0
void AntiGeoCode::slotFinished(QString _t1)
{
